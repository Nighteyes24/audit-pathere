  ...
  function t(n, t) {
        ...
        if (
          ...
          if (
            ...
            !t.triggerOnTouchEnd && u
              ? (We = U(m))
              : t.triggerOnTouchLeave && !u && (We = U(x)),
              (We != S && We != x) || j(n, We);
          }
        } else (We = S), j(n, We);
        !1 === r && ((We = S), j(n, We));
    ...
    function U(e) {
      ...
      return (
        !r || l
          ? (n = S)
          : !i || e != m || (t.triggerOnTouchEnd && !t.triggerOnTouchLeave)
          ? !i && e == x && t.triggerOnTouchLeave && (n = S)
          : (n = x),
        n
      );
    }
      ...
      if (s == f) {
        ...
        if (r == x && V()) {
          if (
            ...
            t.swipe &&
              ((p = t.swipe.call(Ve, n, Ne, je, _e, ze, Ge, He)), !1 === p))
          )
            return !1;
          switch (Ne) {
            case i:
              Ve.trigger("swipeLeft", [Ne, je, _e, ze, Ge, He]),
                t.swipeLeft &&
                  (p = t.swipeLeft.call(Ve, n, Ne, je, _e, ze, Ge, He));
              break;
            case l:
              Ve.trigger("swipeRight", [Ne, je, _e, ze, Ge, He]),
                t.swipeRight &&
                  (p = t.swipeRight.call(Ve, n, Ne, je, _e, ze, Ge, He));
              break;
            case o:
              Ve.trigger("swipeUp", [Ne, je, _e, ze, Ge, He]),
                t.swipeUp &&
                  (p = t.swipeUp.call(Ve, n, Ne, je, _e, ze, Ge, He));
              break;
            case u:
              Ve.trigger("swipeDown", [Ne, je, _e, ze, Ge, He]),
                t.swipeDown &&
                  (p = t.swipeDown.call(Ve, n, Ne, je, _e, ze, Ge, He));
          }
        }
      }
      if (s == h) {
      ...
      return (
        s == d
          ...
          ? (r !== S && r !== x) ||
            ...
            t.doubleTap && (p = t.doubleTap.call(Ve, n, n.target)))
          : s == v &&
            ((r !== S && r !== x) ||
              (clearTimeout(en),
              ($e = null),
              Ve.trigger("longtap", [n.target]),
              t.longTap && (p = t.longTap.call(Ve, n, n.target)))),
        p
      );
    }
    function H() {
    ...
    function C(e, n) {
      if (!1 !== t.preventDefaultEvents)
        if (t.allowPageScroll === s) e.preventDefault();
          ...
          switch (n) {
            case i:
              ((t.swipeLeft && r) || (!r && t.allowPageScroll != w)) &&
                e.preventDefault();
              break;
            case l:
              ((t.swipeRight && r) || (!r && t.allowPageScroll != w)) &&
                e.preventDefault();
              break;
            case o:
              ((t.swipeUp && r) || (!r && t.allowPageScroll != T)) &&
                e.preventDefault();
              break;
            case u:
              ((t.swipeDown && r) || (!r && t.allowPageScroll != T)) &&
                e.preventDefault();
          }
        }
    }
